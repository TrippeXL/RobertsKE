...
import { PRODUCTS, BLOG_POSTS, USERS } from '../constants';
...
const DashboardScreen: React.FC<DashboardScreenProps> = ({ onBack }) => {
  ...
  if (!user || (user.role !== 'staff' && user.role !== 'super-admin')) {
      return (
          <div className="max-w-sm mx-auto bg-[#F9F5F0] min-h-screen flex flex-col">
  ...
  return (
    ...
    <div className="max-w-sm mx-auto bg-[#F9F5F0] min-h-screen">
      <header className="p-4 bg-white shadow-sm flex items-center sticky top-0 z-10">
       ...
       <div className="p-2 bg-white border-b overflow-x-auto scrollbar-hide">
        ...
        {activeTab === 'overview' && (
            <div className="space-y-6">
                 ...
                 <div className="bg-white p-4 rounded-lg shadow-sm">
                    ...
                    <p className="text-sm text-gray-500 text-center py-8">(Simulated Chart Area)</p>
                 </div>
            </div>
        )}
